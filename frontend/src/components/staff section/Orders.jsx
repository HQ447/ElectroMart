      ...
      <div className="p-6 ">
        <div className="bg-white rounded-2xl shadow-lg p-12 text-center">
          ...
          <p className="text-gray-500">
            No orders have been confirmed and are ready to dispatch.
          </p>
        </div>
      </div>
    );
        ...
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-gray-600">
              Manage confirmed orders and update dispatch status
            </p>
          </div>
      ...
      {filteredOrders.length === 0 && searchTerm ? (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          {filteredOrders.map((order) => (
            <div
              key={order._id}
              className="bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden border border-blue-200"
            >
              {/* Order Header */}
                ...
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-blue-100 text-sm">Ready to Dispatch</p>
                    </div>
                  </div>
